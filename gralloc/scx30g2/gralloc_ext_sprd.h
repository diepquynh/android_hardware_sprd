...
enum
{
    GRALLOC_USAGE_SPRD_PRIVATE          =  0x01000000U,
    GRALLOC_USAGE_OVERLAY_BUFFER        =  0x03000000U,
    GRALLOC_USAGE_VIDEO_BUFFER	        =  0x05000000U,
    GRALLOC_USAGE_CAMERA_BUFFER         =  0x05000000U,
    GRALLOC_USAGE_HW_TILE_ALIGN         =  0x08000000U,
};
