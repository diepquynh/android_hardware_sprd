...
typedef cmr_u32(*SENSOR_IOCTL_FUNC_PTR) (cmr_u32 param);

typedef struct sensor_ioctl_func_tab_tag {
	/*1: Internal IOCTL function */
	cmr_u32(*reset) (cmr_u32 param);
	cmr_u32(*power) (cmr_u32 param);
	cmr_u32(*enter_sleep) (cmr_u32 param);
	cmr_u32(*identify) (cmr_u32 param);
	cmr_u32(*write_reg) (cmr_u32 param);
	cmr_u32(*read_reg) (cmr_u32 param);
	/*Custom function */
	cmr_u32(*cus_func_1) (cmr_u32 param);
	cmr_u32(*get_trim) (cmr_u32 param);
	/*External IOCTL function */
	cmr_u32(*ae_enable) (cmr_u32 param);
	cmr_u32(*hmirror_enable) (cmr_u32 param);
	cmr_u32(*vmirror_enable) (cmr_u32 param);

	cmr_u32(*set_brightness) (cmr_u32 param);
	cmr_u32(*set_contrast) (cmr_u32 param);
	cmr_u32(*set_sharpness) (cmr_u32 param);
	cmr_u32(*set_saturation) (cmr_u32 param);
	cmr_u32(*set_preview_mode) (cmr_u32 param);

	cmr_u32(*set_image_effect) (cmr_u32 param);
	//low 16bits is resolution table index,hight 16bits is cap mode containing normal and HDR.
	cmr_u32(*before_snapshort) (cmr_u32 param);
	cmr_u32(*after_snapshort) (cmr_u32 param);
	cmr_u32(*flash) (cmr_u32 param);
	cmr_u32(*read_ae_value) (cmr_u32 param);
	cmr_u32(*write_ae_value) (cmr_u32 param);
	cmr_u32(*read_gain_value) (cmr_u32 param);
	cmr_u32(*write_gain_value) (cmr_u32 param);
	cmr_u32(*read_gain_scale) (cmr_u32 param);
	cmr_u32(*set_frame_rate) (cmr_u32 param);
	cmr_u32(*af_enable) (cmr_u32 param);
	cmr_u32(*af_get_status) (cmr_u32 param);
	cmr_u32(*set_wb_mode) (cmr_u32 param);
	cmr_u32(*get_skip_frame) (cmr_u32 param);
	cmr_u32(*set_iso) (cmr_u32 param);
	cmr_u32(*set_exposure_compensation) (cmr_u32 param);
	cmr_u32(*check_image_format_support) (cmr_u32 param);
	cmr_u32(*change_image_format) (cmr_u32 param);
	cmr_u32(*set_zoom) (cmr_u32 param);
	/*CUSTOMER FUNCTION */
	cmr_u32(*get_exif) (cmr_u32 param);
	cmr_u32(*set_focus) (cmr_u32 param);
	cmr_u32(*set_anti_banding_flicker) (cmr_u32 param);
	cmr_u32(*set_video_mode) (cmr_u32 param);
	cmr_u32(*pick_jpeg_stream) (cmr_u32 param);
	cmr_u32(*set_meter_mode) (cmr_u32 param);
	cmr_u32(*get_status) (cmr_u32 param);
	cmr_u32(*stream_on) (cmr_u32 param);
	cmr_u32(*stream_off) (cmr_u32 param);
	cmr_u32(*cfg_otp) (cmr_u32 param);
