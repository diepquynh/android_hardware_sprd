...
struct utest_jpeg_context {
	...
	uint32_t jpg_pmemory_size;
	int jpg_physical_addr ;
...
static int utest_jpeg_mem_alloc(void)
{
	...
	if (0 == s_mem_method) {
		jpeg_cxt_ptr->input_y_pmem_hp->get_phy_addr_from_ion((int *)(&jpeg_cxt_ptr->input_y_physical_addr),
	...
	if (0 == s_mem_method) {
		jpeg_cxt_ptr->input_uv_pmem_hp->get_phy_addr_from_ion((int *)(&jpeg_cxt_ptr->input_uv_physical_addr),
	...
	if (0 == s_mem_method) {
		jpeg_cxt_ptr->jpg_pmem_hp->get_phy_addr_from_ion((int *)(&jpeg_cxt_ptr->jpg_physical_addr),
...
static int utest_jpg_mem_release(void)
{
	...
	if (jpeg_cxt_ptr->input_y_physical_addr) {
		if (0 == s_mem_method) {
			...
			jpeg_cxt_ptr->input_y_pmem_hp->free_mm_iova(jpeg_cxt_ptr->input_y_physical_addr, jpeg_cxt_ptr->input_y_pmemory_size);
		}
	}
	...
	if (jpeg_cxt_ptr->input_uv_physical_addr) {
		if (0 == s_mem_method) {
			...
			jpeg_cxt_ptr->input_uv_pmem_hp->free_mm_iova(jpeg_cxt_ptr->input_uv_physical_addr, jpeg_cxt_ptr->input_uv_pmemory_size);
		}
	}
	...
	if (jpeg_cxt_ptr->jpg_physical_addr) {
		if (0 == s_mem_method) {
			...
			jpeg_cxt_ptr->jpg_pmem_hp->free_mm_iova(jpeg_cxt_ptr->jpg_physical_addr, jpeg_cxt_ptr->jpg_pmemory_size);
		}
	}
