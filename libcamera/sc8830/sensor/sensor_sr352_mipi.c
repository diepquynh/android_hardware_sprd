...
static uint32_t _sr352_PowerOn(uint32_t power_on);
static uint32_t _sr352_GetResolutionTrimTab(uint32_t param);
static uint32_t _sr352_Identify(uint32_t param);
static uint32_t _sr352_set_brightness(uint32_t level);
static uint32_t _sr352_set_contrast(uint32_t level);
static uint32_t _sr352_set_saturation(uint32_t level);
static uint32_t _sr352_set_image_effect(uint32_t effect_type);
static uint32_t _sr352_set_ev(uint32_t level);
static uint32_t _sr352_set_anti_flicker(uint32_t mode);
static uint32_t _sr352_set_awb(uint32_t mode);
static uint32_t _sr352_set_work_mode(uint32_t mode);
static uint32_t _sr352_BeforeSnapshot(uint32_t param);
static uint32_t _sr352_check_image_format_support(uint32_t param);
static uint32_t _sr352_after_snapshot(uint32_t param);
static uint32_t _sr352_GetExifInfo(uint32_t param);
static uint32_t sr352_InitExt(uint32_t param);
...
static SENSOR_TRIM_T s_sr352_resolution_Trim_Tab[] = {
	...
	{0, 0, 640, 480, 68, 850, 0x03b8, {0, 0, 640, 480}},
...
static uint32_t sr352_InitExt(uint32_t param)	//wujinyou, 2012.11.14
{
...
static uint32_t _sr352_StreamOn(uint32_t param);
static uint32_t _sr352_StreamOff(uint32_t param);
...
static uint32_t _sr352_PowerOn(uint32_t power_on)
{
	...
	SENSOR_PRINT("SENSOR:sr352_Power_Ctrl_1 (1:on, 0:off): %d \n", power_on);
	...
	SENSOR_PRINT("SENSOR:sr352_Power_Ctrl_2 (1:on, 0:off): %d \n", power_on);
	return SENSOR_SUCCESS;
}
...
static uint32_t _sr352_set_brightness(uint32_t level)
{
	...
	SENSOR_PRINT("sensor: terry sr352_set_brightness = 0x%02x.\n", level);
	return 0;
}
...
static uint32_t _sr352_set_contrast(uint32_t level)
{
	...
	SENSOR_PRINT("sensor: terry sr352_set_contrast = 0x%02x.\n", level);
	return 0;
}
...
static uint32_t _sr352_set_saturation(uint32_t level)
{
	...
	SENSOR_PRINT("sensor: terry sr352_set_saturation = 0x%02x.\n", level);
	return 0;
}
...
static uint32_t _sr352_set_image_effect(uint32_t effect_type)
{
	...
	SENSOR_PRINT("sensor: terry sr352_set_image_effect = 0x%02x.\n", effect_type);
	return 0;
}
...
static uint32_t _sr352_set_ev(uint32_t level)
{
	...
	SENSOR_PRINT("sensor: terry sr352_set_ev = 0x%02x.\n", level);
	return 0;
}
...
static uint32_t _sr352_set_anti_flicker(uint32_t mode)
{
	...
	SENSOR_PRINT("sensor: terry _sr352_set_anti_flicker = 0x%02x", mode);
	return 0;
}
...
static uint32_t _sr352_set_video_mode(uint32_t mode)
{//65.6 us
	...
	SENSOR_PRINT("sensor: terry _sr352_set_video_mode = 0x%02x", mode);
	return 0;
}
...
static uint32_t _sr352_set_awb(uint32_t mode)
{
	...
	SENSOR_PRINT("sensor: terry sr352_set_awb = 0x%02x", mode);
	return 0;
}
...
static uint32_t _sr352_BeforeSnapshot(uint32_t param)
{
	...
	param &= 0xffff;
	SENSOR_PRINT("terry  _sr352_BeforeSnapshot =%d.\n",param);
...
static uint32_t _sr352_after_snapshot(uint32_t param)
{
	SENSOR_PRINT("terry  _sr352_after_snapshot =%d.\n",param);
