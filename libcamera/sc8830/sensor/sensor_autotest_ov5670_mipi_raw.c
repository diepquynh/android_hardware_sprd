...
LOCAL SENSOR_REG_TAB_INFO_T s_at_ov5670_resolution_Tab_RAW[] = {
...
LOCAL SENSOR_IOCTL_FUNC_TAB_T s_at_ov5670_ioctl_func_tab = {
	PNULL,
	_ov5670_PowerOn,
	PNULL,
	_ov5670_Identify,
...
SENSOR_INFO_T g_at_ov5670_mipi_raw_info = {
	...
	s_at_ov5670_resolution_Tab_RAW,	// point to resolution table information structure
	&s_at_ov5670_ioctl_func_tab,	// point to ioctl function table
	...
	60, 		// horizontal view angle
	60, 		// vertical view angle
};
...
LOCAL uint32_t _ov5670_GetResolutionTrimTab(uint32_t param)
{
	SENSOR_PRINT("0x%x", (uint32_t)s_ov5670_Resolution_Trim_Tab);
	return (uint32_t) s_ov5670_Resolution_Trim_Tab;
}
