...
static uint32_t GC2155_MIPI_PowerOn(uint32_t power_on);
static uint32_t GC2155_MIPI_Identify(uint32_t param);
static uint32_t Gc2155_GetResolutionTrimTab(uint32_t param);
static uint32_t GC2155_MIPI_BeforeSnapshot(uint32_t param);
static uint32_t GC2155_MIPI_After_Snapshot(uint32_t param);
...
static uint32_t set_GC2155_MIPI_ev(uint32_t level);
static uint32_t set_GC2155_MIPI_awb(uint32_t mode);
static uint32_t set_GC2155_MIPI_anti_flicker(uint32_t mode);
static uint32_t set_GC2155_MIPI_video_mode(uint32_t mode);
static void GC2155_MIPI_set_shutter();
static uint32_t GC2155_MIPI_StreamOn(uint32_t param);
static uint32_t GC2155_MIPI_StreamOff(uint32_t param);
...
static uint32_t Gc2155_GetResolutionTrimTab(uint32_t param)
{
	return (uint32_t) s_Gc2155_Resolution_Trim_Tab;
}
...
static uint32_t set_GC2155_MIPI_anti_flicker(uint32_t param )
{
	shutter_flag = 0;
	switch (param) {
	case FLICKER_50HZ:
...
static uint32_t set_preview_mode(uint32_t preview_mode)
{
	...
	case DCAMERA_ENVIRONMENT_NORMAL:
		//YCP_saturation
		GC2155_MIPI_WriteReg(0xfe , 0x02);
		GC2155_MIPI_WriteReg(0xd1 , 0x28);
		GC2155_MIPI_WriteReg(0xd2 , 0x28);
		GC2155_MIPI_WriteReg(0xfe , 0x01);
	...
	case 3://SENSOR_ENVIROMENT_PORTRAIT://3
		//YCP_saturation
		GC2155_MIPI_WriteReg(0xfe , 0x02);
		GC2155_MIPI_WriteReg(0xd1 , 0x34);
		GC2155_MIPI_WriteReg(0xd2 , 0x34);
		GC2155_MIPI_WriteReg(0xfe , 0x01);
		GC2155_MIPI_WriteReg(0x3c , 0x40);
		GC2155_MIPI_WriteReg(0xfe , 0x00);
	...
	case 4://SENSOR_ENVIROMENT_LANDSCAPE://4
		//nightmode disable
		GC2155_MIPI_WriteReg(0xfe , 0x02);
		GC2155_MIPI_WriteReg(0xd1 , 0x4c);
		GC2155_MIPI_WriteReg(0xd2 , 0x4c);
		GC2155_MIPI_WriteReg(0xfe , 0x01);
		GC2155_MIPI_WriteReg(0x3c , 0x40);
		GC2155_MIPI_WriteReg(0xfe , 0x00);
	...
	case 2://SENSOR_ENVIROMENT_SPORTS://2
		...
		//YCP_saturation
		GC2155_MIPI_WriteReg(0xfe , 0x02);
		GC2155_MIPI_WriteReg(0xd1 , 0x40);
		GC2155_MIPI_WriteReg(0xd2 , 0x40);
		GC2155_MIPI_WriteReg(0xfe , 0x01);
		GC2155_MIPI_WriteReg(0x3c , 0x40);
		GC2155_MIPI_WriteReg(0xfe , 0x00);
...
static uint32_t GC2155_MIPI_BeforeSnapshot(uint32_t sensor_snapshot_mode)
{
