...
static uint32_t HM2058_Identify(uint32_t param);
static uint32_t Set_HM2058_Brightness(uint32_t level);
static uint32_t Set_HM2058_Contrast(uint32_t level);
static uint32_t Set_HM2058_Image_Effect(uint32_t effect_type);
static uint32_t Set_HM2058_Ev(uint32_t level);
static uint32_t Set_HM2058_Anti_Flicker(uint32_t mode);
static uint32_t Set_HM2058_Preview_Mode(uint32_t preview_mode);
static uint32_t set_HM2058_work_mode(uint32_t mode);
static uint32_t Set_HM2058_AWB(uint32_t mode);
static uint32_t HM2058_Before_Snapshot(uint32_t param);
static uint32_t HM2058_After_Snapshot(uint32_t param);
static uint32_t Set_HM2058_Video_Mode(uint32_t mode);
static void HM2058_Write_Group_Regs( SENSOR_REG_T* sensor_reg_ptr );
static uint32_t HM2058_flash(uint32_t param);
static uint32_t set_HM2058_ae_enable(uint32_t enable);
...
static uint32_t _HM2058_GetResolutionTrimTab(uint32_t param)
{
	return (uint32_t)s_HM2058_Resolution_Trim_Tab;
}
...
static uint32_t HM2058_Before_Snapshot(uint32_t param)
{
	...
	CMR_LOGI("SENSOR_HM2058: Before Snapshot 0x%x", param);
