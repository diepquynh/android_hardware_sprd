...
static uint32_t set_SP2529_anti_flicker(uint32_t mode )
{
	...
	case DCAMERA_FLICKER_60HZ:
		Antiflicker = DCAMERA_FLICKER_60HZ;
			...
			SP2529_WriteReg(0x3e,0x5d);
			SP2529_WriteReg(0x3f,0x00);
			SP2529_WriteReg(0x88,0x81);
			SP2529_WriteReg(0x89,0x81);
			SP2529_WriteReg(0x8a,0x55);
			SP2529_WriteReg(0xfd,0x02);
			SP2529_WriteReg(0xbe,0xb9);
			SP2529_WriteReg(0xbf,0x04);
			SP2529_WriteReg(0xd0,0xb9);
			SP2529_WriteReg(0xd1,0x04);
			SP2529_WriteReg(0xc9,0xb9);
			SP2529_WriteReg(0xca,0x04);
		break;
	default:
		break;
...
static uint32_t set_preview_mode(uint32_t preview_mode)
{
	...
	switch (preview_mode)
	{
		...
		if(Antiflicker== DCAMERA_FLICKER_50HZ)
		{
			...
			SP2529_WriteReg(0x8a,0x54);
			SP2529_WriteReg(0xfd,0x02);
			SP2529_WriteReg(0xbe,0x00);
			SP2529_WriteReg(0xbf,0x07);
			SP2529_WriteReg(0xd0,0x00);
			SP2529_WriteReg(0xd1,0x07);
			SP2529_WriteReg(0xc9,0x00);
			SP2529_WriteReg(0xca,0x07);
		}
		else
		{
			// 2pll 6-9fps 60hz binning
			SP2529_WriteReg(0xfd,0x00);
			SP2529_WriteReg(0x03,0x02);
			SP2529_WriteReg(0x04,0x2e);
			SP2529_WriteReg(0x05,0x00);
			...
			SP2529_WriteReg(0x8a,0x55);
			SP2529_WriteReg(0xfd,0x02);
			SP2529_WriteReg(0xbe,0x44);
			SP2529_WriteReg(0xbf,0x07);
			SP2529_WriteReg(0xd0,0x44);
			SP2529_WriteReg(0xd1,0x07);
			SP2529_WriteReg(0xc9,0x44);
			SP2529_WriteReg(0xca,0x07);
		}
		break;
		}
