...
static uint32_t _imx219_GetResolutionTrimTab(uint32_t param);
static uint32_t _imx219_PowerOn(uint32_t power_on);
static uint32_t _imx219_Identify(uint32_t param);
static uint32_t _imx219_BeforeSnapshot(uint32_t param);
static uint32_t _imx219_after_snapshot(uint32_t param);
static uint32_t _imx219_StreamOn(uint32_t param);
static uint32_t _imx219_StreamOff(uint32_t param);
static uint32_t _imx219_write_exposure(uint32_t param);
static uint32_t _imx219_write_gain(uint32_t param);
static uint32_t _imx219_write_af(uint32_t param);
static uint32_t _imx219_flash(uint32_t param);
static uint32_t _imx219_ExtFunc(uint32_t ctl_param);
static uint16_t _imx219_get_VTS(void);
static uint32_t _imx219_set_VTS(uint16_t VTS);
static uint32_t _imx219_ReadGain(uint32_t param);
static uint32_t _imx219_set_video_mode(uint32_t param);
...
static uint32_t _dw9714a_SRCInit(uint32_t mode)
{
...
static uint32_t _imx219_GetResolutionTrimTab(uint32_t param)
{
	SENSOR_PRINT("0x%x",  (uint32_t)s_imx219_Resolution_Trim_Tab);
	return (uint32_t) s_imx219_Resolution_Trim_Tab;
}
...
static uint32_t _imx219_cfg_otp(uint32_t  param)
{
...
static uint32_t _imx219_GetMaxFrameLine(uint32_t index)
{
...
static uint32_t _imx219_after_snapshot(uint32_t param)
{
	SENSOR_PRINT("SENSOR_imx219: after_snapshot mode:%d", param);
...
static uint32_t _imx219_SetEV(uint32_t param)
{
	uint32_t rtn = SENSOR_SUCCESS;
