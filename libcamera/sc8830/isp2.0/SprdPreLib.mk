...
LOCAL_SRC_FILES := $(ISP_LIB_PATH)/lib/libae.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
...
LOCAL_SRC_FILES := $(ISP_LIB_PATH)/lib/libawb.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := $(TARGET_OUT)/lib
endif
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := $(ISP_LIB_PATH)/lib/libcalibration.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := $(TARGET_OUT)/lib
endif
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := isp2.0/sft_af/lib/libAF.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := $(TARGET_OUT)/lib
endif
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := isp2.0/sft_af/lib/libsft_af_ctrl.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := $(TARGET_OUT)/lib
endif
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := isp2.0/sft_af/lib/libaf_tune.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := $(TARGET_OUT)/lib
endif
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := $(ISP_LIB_PATH)/lib/libdeflicker.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := $(TARGET_OUT)/lib
endif
endif
...
LOCAL_SRC_FILES := $(ISP_LIB_PATH)/lib/libspaf.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := $(TARGET_OUT)/lib
endif
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := $(ISP_LIB_PATH)/lib/liblsc.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := $(TARGET_OUT)/lib
endif
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := isp2.0/third_lib/alc_awb/libAl_Awb.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := $(TARGET_OUT)/lib
endif
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := isp2.0/third_lib/alc_awb/libAl_Awb_Sp.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := $(TARGET_OUT)/lib
endif
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := isp2.0/third_lib/alc_af/lib/libaf_running.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := $(TARGET_OUT)/lib
endif
include $(BUILD_PREBUILT)
...
ifeq ($(strip $(TARGET_BOARD_USE_ALC_AE_AWB)),true)
	ifeq ($(strip $(TARGET_ARCH)),arm)
		...
		LOCAL_SRC_FILES := isp2.0/alc_ip/ais/libAl_Ais.so
		LOCAL_MODULE_TAGS := optional
		LOCAL_MODULE_SUFFIX := .so
		LOCAL_MODULE_CLASS := SHARED_LIBRARIES
		LOCAL_MODULE_PATH := $(TARGET_OUT)/lib
		...
		LOCAL_SRC_FILES := isp2.0/alc_ip/ais/libAl_Ais_Sp.so
		LOCAL_MODULE_TAGS := optional
		LOCAL_MODULE_SUFFIX := .so
		LOCAL_MODULE_CLASS := SHARED_LIBRARIES
		LOCAL_MODULE_PATH := $(TARGET_OUT)/lib
