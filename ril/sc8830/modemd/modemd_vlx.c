...
#ifdef SCX30G_V2
#define EMMC_PARTITION_NAME "sdio_emmc"
#else
#define EMMC_PARTITION_NAME "sprd-sdhci.3"
#endif

#define PARTITION_PATH "/dev/block/platform/" EMMC_PARTITION_NAME "/by-name"

#ifdef CONFIG_EMMC
/* see g_sprd_emmc_partition_cfg[] in u-boot/nand_fdl/fdl-2/src/fdl_partition.c */
#define PARTITION_MODEM        PARTITION_PATH "/MODEM"
#define PARTITION_DSP          PARTITION_PATH "/WDSP"
#define PARTITION_FIX_NV1      PARTITION_PATH "/wfixnv1"
#define PARTITION_FIX_NV2      PARTITION_PATH "/wfixnv2"
#define PARTITION_RUNTIME_NV1  PARTITION_PATH "/wruntimenv1"
#define PARTITION_RUNTIME_NV2  PARTITION_PATH "/wruntimenv2"
#define PARTITION_PROD_INFO    PARTITION_PATH "/prodnv"
