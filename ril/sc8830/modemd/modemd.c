...
{
    char nvitemd[20] = { 0 };
    snprintf(nvitemd, sizeof(nvitemd), "nvitemd_%s", modem);
    MODEMD_LOGD("stop %s nvitemd!", modem);
...
static int start_nvitemd(char * modem)
{
    char nvitemd[20] = { 0 };
    snprintf(nvitemd, sizeof(nvitemd), "nvitemd_%s", modem);
    MODEMD_LOGD("start %s nvitemd!", modem);
...
{
    char phoneserver[20] = { 0 };
    snprintf(phoneserver, sizeof(phoneserver), "phoneserver_%s", modem);
...
static int stop_rild(char * modem)
{
    ...
    if (!strcmp(phoneCount, "2")) {
        ...
        property_set("ctl.stop", "ril-daemon2");
        property_set("ctl.stop", "ril-daemon3");
    }
...
static int start_rild(char * modem)
{
    ...
    if (!strcmp(phoneCount, "2")) {
        ...
        property_set("ctl.start", "ril-daemon2");
        property_set("ctl.start", "ril-daemon3");
    }
